...
### FEMA DATASET ###
# loading dataset from Kaggle that was downloaded to csv
...
# calculating percent missing values of rows for each column to understand the impact of replacing NaN with 0's
...
location_file_name = "~/Desktop/employment.csv" # UPDATE WITH FILEPATH
...
# graph 3 Median Home Prices by State
...
ax = sns.barplot(x=location_df['region'], y=location_df['percent_of_class'], palette="rocket") #box plot
ax.set_title('Percent of Class by Region')
plt.show()
